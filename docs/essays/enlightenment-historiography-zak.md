...
### Access
{% include figure.html class="img-right" src="Republic of letters.jpg" caption= "Achille Devaria, Voltaire Greeting Ben Franklin and his Nephew. National Endowment for the Humanitites, " %}
...
{% include figure.html class="img-right" src="Herder.jpg" %}
